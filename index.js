...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.ja6za.mongodb.net/myFirstDatabase?retryWrites=true&w=majority`;
...
const run = async () => {
  try{
    ...
    const database = client.db("motorcycles-online-store");
    const bikeCollection = database.collection("motorcycles");
